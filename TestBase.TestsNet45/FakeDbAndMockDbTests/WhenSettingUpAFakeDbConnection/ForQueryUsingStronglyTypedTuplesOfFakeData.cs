    ...
    public class ForQueryUsingStronglyTypedTuplesOfFakeData
    {
        ...
        public void Should_return_the_setup_data__Given_an_array_of_tuples_of_fakedata()
        {
            ...
            var dataToReturn = new[]
                               {
                               new Tuple<Source1, Source2>(new Source1 {Id = 11, Name      = "cell 1,1"},
                                                           new Source2 {Id = 21, Source1Id = 11}),
                               new Tuple<Source1, Source2>(new Source1 {Id = 21, Name      = "cell 2,1"},
                                                           new Source2 {Id = 22, Source1Id = 21})
                               };
            ...
            fakeConnection.Query<Source1, Source2, Source2>(
                          ...
                          .ShouldEqualByValue(dataToReturn
                                             .Select(
                                                     t =>
                                                     {
                                                         t.Item2.HydratedSource1Parent = t.Item1;
                                                         return t.Item2;
                                                     }
                                                    )
                                             );
