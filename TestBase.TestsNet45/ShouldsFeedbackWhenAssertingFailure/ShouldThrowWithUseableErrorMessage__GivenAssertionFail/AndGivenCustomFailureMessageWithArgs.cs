...
namespace TestBase.TestsNet45.ShouldsFeedbackWhenAssertingFailure.ShouldThrowWithUseableErrorMessage__GivenAssertionFail
{
    ...
    public static class TestCasesForCustomFailureMessageWithArgs
    {
        ...
        {"ShouldBeOneOf", () => "18".ShouldBeOneOf(new[] {"17", "19"}, FailureMessageWith, FakeDetailArg)},
        {"ShouldBeIn", () => "18".ShouldBeIn(new[] {"17", "19"}, FailureMessageWith, FakeDetailArg)},
        {"ShouldNotBeOneOf", () => "18".ShouldNotBeOneOf(new[] {"17", "18"}, FailureMessageWith, FakeDetailArg)},
        {"ShouldNotBeInList", () => "18".ShouldNotBeInList(new[] {"17", "18"}, FailureMessageWith, FakeDetailArg)},
        {"ShouldNotContain(string)", () => "18".ShouldNotContain("18", FailureMessageWith, FakeDetailArg)},
        {"ShouldContain(string)", () => "18".ShouldContain("boo", FailureMessageWith, FakeDetailArg)},
        {
        "ShouldContainEachOf(string)",
        () => "18".ShouldContainEachOf(new[] {"boo", "booboo"}, FailureMessageWith, FakeDetailArg)
        },
        ...
        {
        "ShouldSatisfy",
        () => 22.ShouldSatisfy(i => i.ToString(), x => x.Equals("boo"), FailureMessageWith, FakeDetailArg)
        },
        {
        ...
        () => new List<int> {2, 1}.ShouldContain(x => x < 0, FailureMessageWith, FakeDetailArg)
        },
        {"ShouldNotContain(item)", () => new List<int> {1, 2}.ShouldNotContain(1, FailureMessageWith, FakeDetailArg)},
        {
        "ShouldNotContain(predicate)",
        () => new List<int> {2, 1}.ShouldNotContain(x => x > 0, FailureMessageWith, FakeDetailArg)
        }
        };
    }
}
