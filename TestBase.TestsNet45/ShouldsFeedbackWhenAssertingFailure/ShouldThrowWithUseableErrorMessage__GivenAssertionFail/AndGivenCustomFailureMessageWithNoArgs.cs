...
namespace TestBase.Tests.ShouldsFeedbackWhenAssertingFailure.ShouldThrowWithUseableErrorMessage__GivenAssertionFail
{
    ...
    public static class TestCasesForCustomFailureMessageWithNoArgs
    {
        public static readonly Dictionary<string, Action> AssertionsWithCustomMessage = new Dictionary<string, Action>
        {
            ...
            { "ShouldBeGreaterThan.2",    () => 11.ShouldBeGreaterThan(11, TestCasesForCustomFailureMessageWithArgs.FailureMessage ) }, 
            { "ShouldBeGreaterThanOrEqualTo", () => 12.ShouldBeGreaterThanOrEqualTo(122, TestCasesForCustomFailureMessageWithArgs.FailureMessage ) }, 
            { "ShouldBeLessThan",    () => 11.ShouldBeLessThan(1, TestCasesForCustomFailureMessageWithArgs.FailureMessage ) }, 
            { "ShouldBeLessThan.2",    () => 11.ShouldBeLessThan(11, TestCasesForCustomFailureMessageWithArgs.FailureMessage ) }, 
            { "ShouldBeLessThanOrEqualTo", () => 12.ShouldBeLessThanOrEqualTo(2, TestCasesForCustomFailureMessageWithArgs.FailureMessage ) }, 
            ...
            { "ShouldNotContain(string)", () => "18".ShouldNotContain("18", TestCasesForCustomFailureMessageWithArgs.FailureMessage ) } ,
            { "ShouldContain(string)", () => "18".ShouldContain("boo", TestCasesForCustomFailureMessageWithArgs.FailureMessage) } ,
            { "ShouldContainEachOf(string)", () => "18".ShouldContainEachOf( new[]{"boo","booboo"}, TestCasesForCustomFailureMessageWithArgs.FailureMessage ) } ,
            { "ShouldBeOneOf", () => "18".ShouldBeOneOf( new[]{ "17", "19"}, TestCasesForCustomFailureMessageWithArgs.FailureMessage) } ,
            { "ShouldBeIn", () => "18".ShouldBeIn( new[]{ "17", "19"}, TestCasesForCustomFailureMessageWithArgs.FailureMessage) } ,
            { "ShouldNotBeOneOf", () => "18".ShouldNotBeOneOf( new[]{ "17", "18"}, TestCasesForCustomFailureMessageWithArgs.FailureMessage ) } ,
            { "ShouldNotBeInList", () => "18".ShouldNotBeInList( new[]{ "17", "18"}, TestCasesForCustomFailureMessageWithArgs.FailureMessage ) } ,
            ...
            { "ShouldContain(item)", () => (new List<int>{1,2}).ShouldContain(3,   TestCasesForCustomFailureMessageWithArgs.FailureMessage ) } ,
            { "ShouldContain(predicate)", () => (new List<int>{2,1}).ShouldContain(x => x<0 , TestCasesForCustomFailureMessageWithArgs.FailureMessage ) } ,
            { "ShouldNotContain(item)", () => (new List<int>{1,2}).ShouldNotContain(1,   TestCasesForCustomFailureMessageWithArgs.FailureMessage ) } ,
            { "ShouldNotContain(predicate)", () => (new List<int>{2,1}).ShouldNotContain(x => x>0 , TestCasesForCustomFailureMessageWithArgs.FailureMessage ) } ,
        };
    }
}