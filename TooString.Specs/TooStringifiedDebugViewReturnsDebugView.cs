...
public class TooStringifiedDebugViewReturnsDebugView
{
    ...
    {
        Assert.That(value.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false), Is.EqualTo(expected));
    }
    ...
    public void GivenAnEnumerable(object value, string expectedPart)
    {
        ...
        var actual = subject.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false);
        TestContext.Progress.WriteLine(actual);
        Assert.That(actual, Is.EqualTo(expected));

        var subject2= new[] { 1, value, 3};
        var expected2= "[ 1, " + expectedPart + ", 3 ]";
        var actual2 = subject2.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false);
    ...
    public void GivenANumeric()
    {
        ...
        foreach (var example in examples)
        {
            ...
            var actual = example.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false);
            Assert.That(actual, Is.EqualTo(expected));
        }
    }
    ...
    public void GivenADateTimeOrDateOrTimeOrTimeSpan()
    {
        ...
        var nowActual = now.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false);
        ...
        var dateOnlyActual = dateOnly.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false);
        ...
        var timeOnlyActual = timeOnly.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false);
        ...
        var timeSpanActual = timeSpan.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false);
    ...
    public void GivenStruct()
    {
        ...
        Assert.That(
            value.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false), 
    ...
    public void GivenTuple()
    {
        ...
        Assert.That(value.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false), Is.EqualTo(value.ToString()));
    }
    ...
    public void GivenNamedTuple()
    {
        ...
        TestContext.Progress.WriteLine(value.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false));
        TestContext.Progress.WriteLine(value.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false));
    ...
    public void GivenNamedTupleWithNumerics()
    {
        ...
        var actual = value.TooString(maxDepth: 3, stringifyAs: StringifyAs.DebugView, writeIndented: false);
