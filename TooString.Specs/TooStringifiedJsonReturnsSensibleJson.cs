...
public class TooStringifiedJsonReturnsSensibleJson
{
    ...
    public void GivenAnUnJsonableReflectionType_Assembly()
    {
        ...
        var expected = """
                       ...
                       """;
#endif
        var actual = value.TooString(StringifyAs.JsonStringifier,TooStringOptions.ForJson with {MaxDepth = 2});
        ...
        var testThisFar = 2000;
        Assert.That(comparableValue.Substring(0,testThisFar),
                    Is.EqualTo(expected.Substring(0,testThisFar)
