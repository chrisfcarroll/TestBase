...
public class TooStringifiedJsonReturnsSensibleJson
{
    ...
    public void GivenAnUnJsonableReflectionType_Assembly()
    {
        ...
        var expected = """
                       ...
                       """;
#endif
        var actual = value.TooString(TooStringStyle.JsonStringifier,TooStringOptions.ForJson() with {ReflectionOptions = TooStringOptions.ForJson().ReflectionOptions with {MaxDepth = 2}});
