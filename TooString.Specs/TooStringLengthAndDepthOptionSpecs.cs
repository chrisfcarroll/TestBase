...
public class TooStringLengthAndDepthOptionSpecs
{
    ...
    {
        var actual1= deep.TooString(maxDepth: 1,style:TooStringStyle.DebugView);
        var expected1 = """{ A = 1, B = { Type = List<CircularLong>, Count = 1 } }""";
        Assert.That(actual1, Is.EqualTo(expected1));

        var actual2= deep.TooString(maxDepth: 2,style:TooStringStyle.DebugView);
        var expected2 = """{ A = 1, B = { Type = List<CircularLong>, Count = 1 } }""";
        Assert.That(actual2, Is.EqualTo(expected2));

        var actual3= deep.TooString(maxDepth: 3,style:TooStringStyle.DebugView);
        var expected3 = """{ A = 1, B = [ { A = 3, B = { Type = List<CircularLong>, Count = 1 } } ] }""";
        Assert.That(actual3, Is.EqualTo(expected3));

        var actual4= deep.TooString(maxDepth: 4,style:TooStringStyle.DebugView);
        var expected4 = """{ A = 1, B = [ { A = 3, B = { Type = List<CircularLong>, Count = 1 } } ] }""";
         Assert.That(actual4, Is.EqualTo(expected4));

        var actual5= deep.TooString(maxDepth: 5,style:TooStringStyle.DebugView);
    ...
    {
        var actual1= lengthy.TooString(maxDepth: 2, maxLength:1, style:TooStringStyle.DebugView);
        var expected1 = """{ A = 0, B = { Type = List<CircularLong>, Count = 9 } }""";
        Assert.That(actual1, Is.EqualTo(expected1));

        var actual2= lengthy.TooString(maxDepth: 2, maxLength:2, style:TooStringStyle.DebugView);
        var expected2 = """{ A = 0, B = { Type = List<CircularLong>, Count = 9 } }""";
        Assert.That(actual2, Is.EqualTo(expected2));

        var actual3= lengthy.TooString(maxDepth: 3, maxLength:2, style:TooStringStyle.DebugView);
        var expected3 = """{ A = 0, B = [ { A = 1, B = { Type = List<CircularLong>, Count = 0 } }, { A = 2, B = { Type = List<CircularLong>, Count = 0 } } ] }""";
        Assert.That(actual3, Is.EqualTo(expected3));

        var actual4= lengthy.TooString(maxDepth: 3, maxLength:4, style:TooStringStyle.DebugView);
        var expected4 = "{ A = 0, B = [ " +
        ...
        var actual5= lengthy.TooString(maxDepth: 3, maxLength:99, style:TooStringStyle.DebugView);
        var expected5 = "{ A = 0, B = [ " +
                        "{ A = 1, B = { Type = List<CircularLong>, Count = 0 } }, " +
                        "{ A = 2, B = { Type = List<CircularLong>, Count = 0 } }, " +
                        "{ A = 3, B = { Type = List<CircularLong>, Count = 0 } }, " +
    ...
    {
        var actual20= lengthy.TooString(maxDepth: 2, maxLength:0, style:TooStringStyle.DebugView);
        var expected20 = """{ A = 0, B = { Type = List<CircularLong>, Count = 9 } }""";
        Assert.That(actual20, Is.EqualTo(expected20));

        var actual30= lengthy.TooString(maxDepth: 3, maxLength:0, style:TooStringStyle.DebugView);
    ...
    {
        var actual21= lengthyAndDeep.TooString(maxDepth: 2, maxLength: -1, style:TooStringStyle.DebugView);
        var expected21 = """{ A = 1, B = { Type = List<CircularLong>, Count = 3 } }""";
        Assert.That(actual21, Is.EqualTo(expected21));

        var actual22= lengthyAndDeep.TooString(maxDepth: 2, maxLength: -2, style:TooStringStyle.DebugView);
        var expected22 = """{ A = 1, B = { Type = List<CircularLong>, Count = 3 } }""";
        Assert.That(actual22, Is.EqualTo(expected22));

        var actual32= lengthyAndDeep.TooString(maxDepth: 3, maxLength: -2, style:TooStringStyle.DebugView);
        var expected32 = """{ A = 1, B = [ { A = 1, B = { Type = List<CircularLong>, Count = 3 } } ] }""";
        Assert.That(actual32, Is.EqualTo(expected32));

        var actual92= lengthyAndDeep.TooString(maxDepth: 9, maxLength: -2, style:TooStringStyle.DebugView);
        var expected92 = "{ A = 1, B = [ " +
                                        "{ A = 1, B = [ { A = 11, B = { Type = List<CircularLong>, Count = 0 } } ] } " +
                                        "] }";
        Assert.That(actual92, Is.EqualTo(expected92));

        var actual94= lengthyAndDeep.TooString(maxDepth: 9, maxLength: -4, style:TooStringStyle.DebugView);
        var expected94 =
            "{ A = 1, B = [ " +
                        "{ A = 1, B = [ { A = 11, B = { Type = List<CircularLong>, Count = 0 } } ] }, " +
        ...
        var actual95= lengthyAndDeep.TooString(maxDepth: 9, maxLength: -5, style:TooStringStyle.DebugView);
        var expected95 =
            "{ A = 1, B = [ " +
        ...
        var actual96= lengthyAndDeep.TooString(maxDepth: 9, maxLength: -6, style:TooStringStyle.DebugView);
        var expected96 =
            "{ A = 1, B = [ " +
