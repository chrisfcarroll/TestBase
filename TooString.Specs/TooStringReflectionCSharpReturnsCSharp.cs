...
public class TooStringReflectionCSharpReturnsCSharp
{
    ...
    public void CSharp_simple_object_has_valid_syntax()
    {
        ...
        var result = person.TooString(ReflectionStyle.CSharp);
    ...
    {
        var items = new[] { 1, 2, 3 };
        var result = items.TooString(ReflectionStyle.CSharp);
        TestContext.Out.WriteLine(result);
    ...
    public void CSharp_array_of_objects()
    {
        ...
        var result = people.TooString(ReflectionStyle.CSharp);
        TestContext.Out.WriteLine(result);
    ...
    public void CSharp_string_is_quoted()
    {
        ...
        var result = text.TooString(ReflectionStyle.CSharp);
        TestContext.Out.WriteLine(result);
    ...
    public void CSharp_boolean_is_lowercase()
    {
        ...
        Assert.That(t.TooString(ReflectionStyle.CSharp), Is.EqualTo("true"));
        Assert.That(f.TooString(ReflectionStyle.CSharp), Is.EqualTo("false"));
    }
    ...
    public void CSharp_tuple_uses_parentheses()
    {
        ...
        var result = tuple.TooString(ReflectionStyle.CSharp);
        TestContext.Out.WriteLine(result);
    ...
    {
        string? value = null;
        var result = value.TooString(ReflectionStyle.CSharp);
    ...
    {
        var n = 42;
        var result = n.TooString(ReflectionStyle.CSharp);
    ...
    public void CSharp_datetime_is_quoted_string()
    {
        ...
        var result = dt.TooString(ReflectionStyle.CSharp);
        TestContext.Out.WriteLine(result);
