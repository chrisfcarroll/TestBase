...
public class TooStringBestEffortMakesGoodChoices
{
    ...
    public void GivenAnUnJsonableReflectionType__ReturnsReflectedJson()
    {
        ...
        var expected = """
                       ...
                       """;
#endif
        var actual = value.TooString(TooStringStyle.Json);
        ...
        var expandoTooStringRx = expandoObject.TooString(TooStringStyle.Json)
