...
namespace PredicateDictionary.Specs.PredicateToFuncDictionarySpecs
{
    public class TryGetValueReturnsTheRightStoredValue
    {
        ...
        public void GivenAKeySatisfyingAPredicate()
        {
            ...
            uut.TryGetValue("", out var value).ShouldBeTrue();
            value.ShouldBe(9);
        }
        ...
        public void GivenAKeySatisfyingNoPredicates()
        {
            ...
            uut.TryGetValue("", out var value).ShouldBeFalse();
            value.ShouldBe(0);
        }
        ...
        public void GivenMultipleEntries()
        {
            ...
            uut.TryGetValue("N", out var value1).ShouldBeTrue();
            value1.ShouldBe(9);

            uut.TryGetValue("Nine", out var value2).ShouldBeTrue();
            value2.ShouldBe(9);

            uut.TryGetValue("E", out var value3).ShouldBeTrue();
            value3.ShouldBe(8);

            uut.TryGetValue("Eight", out var value4).ShouldBeTrue();
            value4.ShouldBe(8);
        }
