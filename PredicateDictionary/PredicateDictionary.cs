...
{
    ///  <inheritdoc cref="List{KeyValuePairKeyIsFuncTBoolValueIsTValue}"/>
    /// <inheritdoc cref="IReadOnlyDictionary{TKey,TValue}"/>
    ///  <summary>PredicateDictionary is something like a Dictionary, but with predicates for keys
    ...
    ///  </summary>
    ///  <example><c>
    ///  var dict= new PredicateDictionary<string, string>();
    ...
    public class PredicateDictionary<T, TValue> : List<KeyValuePair<Func<T, bool>, TValue>>, IReadOnlyDictionary<T, TValue>
    {
        ...
        /// the <see cref="PredicateDictionary{T,TValue}"/> 
        /// </summary>
        /// <param name="value">Contains the value associated with the first matched predicate, if any,
        ...
        /// </summary>
        /// <exception cref="KeyNotFoundException">Thrown if <paramref name="key"/> does not satisfy any
        ...
        /// <summary>If <paramref name="keyPredicate"/> is a predicate in the dictionary, returns
