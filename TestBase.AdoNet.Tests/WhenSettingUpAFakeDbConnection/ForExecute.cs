...
public class ForExecute
{
    ...
    public void When_SetupForExecuteNonQuery__Given__Using_Dapper__Should_return_the_setup_int()
    {
            ...
            //A      fakeConnection.Execute("").ShouldEqual(123);
        }

    [Test]
    public async Task
        When_SetupForExecuteNonQuery__Given__Using_Dapper__Should_return_the_setup_int__GivenExecuteAsync()
    {
            //A
            var fakeConnection = new FakeDbConnection().SetUpForExecuteNonQuery(123);

            //A      (await fakeConnection.ExecuteAsync("")).ShouldEqual(123);
        }
    ...
    public void When_SetupForExecuteNonQuery__Should_return_the_setup_int()
    {
            ...
            //A      fakeConnection.CreateCommand().ExecuteNonQuery().ShouldEqual(123);
        }
    ...
    public async Task When_SetupForExecuteNonQuery__Should_return_the_setup_int__GivenQueryAsync()
    {
            ...
            //A      (await fakeConnection.CreateCommand().ExecuteNonQueryAsync()).ShouldEqual(123);
        }
    ...
    public void When_SetupForExecuteScalar__Should_return_scalar()
    {
            ...
            //A      fakeConnection.CreateCommand().ExecuteScalar().ShouldEqualByValue(value);
        }
}