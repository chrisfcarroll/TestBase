...
namespace TestBase.HttpClient.Fake
{
    public static class FakeHttpClientSetUpPostExtensions
    {
        ...
        /// <summary>Setup this Client to return a desired <see cref="HttpResponseMessage"/> in response to any
        ...
        /// <returns>this, wrapped awaiting the <see cref="FakeHttpClient.FakeHttpClientSetup.Returns(HttpResponseMessage)"/>
        ...
        /// <summary>Setup this Client to return a desired <see cref="HttpResponseMessage"/> in response to a
        /// <see cref="HttpMethod.Post"/> <see cref="HttpRequestMessage"/> whose
        ...
        /// call to specify the response</returns>
        public static FakeHttpClient.FakeHttpClientSetup SetupPost(this FakeHttpClient @this, string urlPattern, string contentPattern)
        {
            bool Predicate(HttpRequestMessage m)
            {
        ...
        /// <param name="this">The <see cref="FakeHttpClient"/> being setup</param>
        /// <param name="urlPattern">The regex pattern to match incoming <see cref="HttpRequestMessage.RequestUri"/> against.</param>
        /// <param name="subarrayToMatch">The incoming <see cref="HttpRequestMessage.Content"/> will be read as a
        /// <see cref="ByteArrayContent"/> and searched for whether the byte sequence <paramref name="subarrayToMatch"/> is
        /// found within it.</param>
        /// <returns>this, wrapped awaiting the <see cref="FakeHttpClient.FakeHttpClientSetup.Returns(HttpResponseMessage)"/>
        /// call to specify the response</returns>
        public static FakeHttpClient.FakeHttpClientSetup SetupPost(this FakeHttpClient @this, string urlPattern, byte[] subarrayToMatch)
        {
            bool Predicate(HttpRequestMessage m)
            {
                var uriMatches = Regex.IsMatch(m.RequestUri.ToString(), urlPattern);
        ...
        /// <param name="this">The <see cref="FakeHttpClient"/> being setup</param>
        /// <param name="urlPattern">The regex pattern to match incoming <see cref="HttpRequestMessage.RequestUri"/> against.</param>
        /// <param name="streamPredicate">The incoming <see cref="HttpRequestMessage.Content"/> will be passed to this
        /// to determine whether it counts as a match or not.</param>
        /// <returns>this, wrapped awaiting the <see cref="FakeHttpClient.FakeHttpClientSetup.Returns(HttpResponseMessage)"/>
        /// call to specify the response</returns>
        public static FakeHttpClient.FakeHttpClientSetup SetupPost(this FakeHttpClient @this, 
                                                                   string urlPattern, 
