...
namespace TestBase.AdoNet
{
    public static class DbRehydrationExtensions
    {
        ...
        ///     overloads of
        ///     <see cref="FakeDbCommand.ForExecuteQuery(System.Collections.Generic.IEnumerable{object[]},string[])" /> which
        ///     deduce MetaData by reflection
        /// </summary>
        /// <returns>
        ///     A list of names of properties of <paramref name="type" /> which can be rehydrated
        ...
        /// <summary>
        ///     This method identifies a constructor having parameters which match (by type and case-insensitive name ) the
        ///     read-only properties
        ///     of an instance of <paramref name="type" />, and returns the <see cref="ParameterInfo" />s in question.
        /// </summary>
        /// <returns>
        ///     A list of names of <strong>readable</strong> properties of <paramref name="type" /> which are
        ///     (1) ValueTypes or string (and not complex types) and (2) can be set in one of <paramref name="type" />'s
        ///     constructors.
        ...
        public static ParameterInfo[] GetReadableValueTypesAndStringConstructorParameters(Type type)
        {
            var readablePrimitives = type.GetProperties()
                                         .Where(x => x.CanRead)
                                         .Where(x => x.PropertyType.GetTypeInfo().IsValueType
        ...
        /// <returns>
        ///     A list of <strong>writeable</strong> properties of <paramref name="type" /> which can be rehydrated
        ///     from a SQL select: value types and strings but not complex types.
        /// </returns>
