...
namespace TestBase.AdoNet
{
    public static class DbConnectionVerifyExtensions
    {
        ...
        /// <param name="exactly">
        ///     Should the <see cref="expectedInvocationsCount" />be treated as requiring an exact match or an
        ///     'at least' match?
        /// </param>
        ...
        /// <returns></returns>
        public static FakeDbConnection Verify(
            this FakeDbConnection     @this,
            ...
            if (exactly)
                @this.Invocations
                     ...
                     .ShouldBe(expectedInvocationsCount,
                               string.Format(message ?? "Expected to be called exactly {0} times",
                ...
                @this.Invocations
                     ...
                     .ShouldBeGreaterThanOrEqualTo(expectedInvocationsCount,
                                                   string.Format(message ?? "Expected to be called at least {0} times",
                                                                 args.Length == 0
                                                                 ? new object[] {expectedInvocationsCount}
                                                                 : args)
                                                  );
            return @this;
        }
        ...
        public static FakeDbCommand VerifyFirst(
            this FakeDbConnection                 @this,
            ...
            params object[]                       args)
        {
            return @this.Invocations
                        ...
                        .ShouldNotBeNull(
                                         message
                                      ?? $"Expected at least once command matching {commandInvocationPredicate.ToCodeString()}",
                                         args);
        }
        ...
        /// <exception cref="Assertion">thrown if no matching command is found</exception>
        public static FakeDbCommand VerifyLast(
            this FakeDbConnection                 @this,
            Expression<Func<FakeDbCommand, bool>> commandInvocationPredicate,
            string                                message = null,
            params object[]                       args)
        ...
        /// <summary>
        ///     Verifies that the <see cref="FakeDbConnection" /> was asked exactly once to execute a command matching the given
        ///     predicate and returns that single invocation.
        /// </summary>
        /// <param name="this">The FakeDbConnection</param>
        /// <param name="commandInvocationPredicate">A predicate, which may examine the command (and its parameters) sent</param>
        /// <param name="message">Optional custom failure message</param>
        ...
        public static FakeDbCommand VerifySingle(
            this FakeDbConnection                 @this,
            Expression<Func<FakeDbCommand, bool>> commandInvocationPredicate,
            string                                message = null,
            params object[]                       args)
        {
            ...
            @this.Invocations.Count(predicate)
                 .ShouldBe(1,
                           message
                        ?? $"Expected exactly one command matching {commandInvocationPredicate.ToCodeString()}",
                           args);
