...
namespace TestBase
{
    public static class EnumerableExtensions
    {
        ...
        /// <returns>
        ///     <c>Array.Find{T}(<paramref name="items" />, <paramref name="predicate" />)</c>
        /// </returns>
        public static T Find<T>(this T[] items, Func<T, bool> predicate)
        {
            return Array.Find(items, new Predicate<T>(predicate));
        }
        ...
        /// <param name="predicate"></param>
        /// <returns>
        ///     <c>Array.FindAll{T}(<paramref name="items" />, <paramref name="predicate" />)</c>
        /// </returns>
