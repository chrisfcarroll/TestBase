...
namespace TestBase.FakeDb
{
    public static class FakeDbConnectionExtensions
    {
        ...
        /// <see cref="DbCommand.ExecuteReader()"/> is called on it.
        /// 
        /// The returned rows will have <see><cref>dataToReturn.Length</cref></see> columns. The columns will be 
        /// named from the left with the names given in <param name="columnNames"></param>. If not enough names are
