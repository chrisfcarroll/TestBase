...
namespace TestBase
{
    ...
    public static class Assert
    {
        ...
        ///     <para>A synonym for <see cref="Should.Throw(Expression{Action},string,object[])"/>.</para>
        /// </summary>
        ...
        ///     <para>A synonym for <see cref="Should.Throw{TE}(Action,string,object[])"/>.</para>
        /// </summary>
        ...
        ///     <para>A synonym for <see cref="Should.Throw{T,TE}(T,Expression{Func{T,bool}},string,object[])"/>.</para>
        /// </summary>
        /// <typeparam name="TE"></typeparam>
        /// <typeparam name="T"></typeparam>
        /// <returns>The caught exception</returns>
        ...
        ///     <para>A synonym for <see cref="Should.NotThrow(Expression{Action},string,object[])"/>.</para>
        /// </summary>
        /// <returns>
