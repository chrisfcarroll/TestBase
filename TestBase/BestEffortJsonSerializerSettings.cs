...
{
    /// <summary>
    ///     An instance of <see cref="JsonSerializerSettings" /> which will make a best effort to complete serialization,
    ...
    public static class BestEffortJsonSerializerSettings
    {
        ...
        static BestEffortJsonSerializerSettings() { Serializer.Converters.Add(new DBNullConverter()); }
        ...
        public class DBNullConverter : JsonConverter
        {
            ...
            /// </summary>
            public static readonly object value = DBNull.Value;
            ...
            /// </returns>
            public override bool CanConvert(Type objectType) { return objectType.FullName == "System.DBNull"; }
        }
    }
}
