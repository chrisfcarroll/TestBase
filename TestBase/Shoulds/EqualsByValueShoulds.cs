...
namespace TestBase
{
    public static class EqualsByValueShoulds
    {
        ...
        /// <returns><param name="actual"></param></returns>
        /// <exception cref="Assertion">Returns a message indicating where the comparision failed</exception>
        public static T ShouldEqualByValueOnMembers<T>(this T actual, 
                                object expectedValue, IEnumerable<string> propertiesToCompare, string message=null, params object[] args)
        {
            Assert.That(actual, x=>x.EqualsByValuesJustOnMembersNamed(expectedValue, propertiesToCompare), message, args);
            return actual;
        }
        ...
        /// <returns><param name="actual"></param></returns>
        /// <exception cref="Assertion">Returns a message indicating where the comparision failed</exception>
        public static T ShouldEqualByValueOnProperties<T>(this T actual, object expectedValue, params string[] propertiesToCompare)
        {
