...
namespace TestBase.Shoulds
{
    public static class BasicShoulds
    {
        ...
        {
            NUnit.Framework.Assert.That(@this, Is.Null, message, args);
        }

        public static void ShouldBeNullOrEmpty(this string @this, [Optional] string message, params object[] args)
        {
            NUnit.Framework.Assert.That(String.IsNullOrEmpty(@this), message??"Should Be Null Or Empty", args);
        }

        public static void ShouldBeEmpty(this string @this, [Optional] string message, params object[] args)
        {
            NUnit.Framework.Assert.That(@this.Length == 0, message??"Should Be Empty", args);
        }
        ...
        {
            NUnit.Framework.Assert.That(@this, Is.InstanceOf<T>(), message, args);
        ...
        {
            NUnit.Framework.Assert.That(@this, Is.AssignableTo<T>(), message, args);
