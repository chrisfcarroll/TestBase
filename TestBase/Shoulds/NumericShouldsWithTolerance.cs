...
namespace TestBase
{
    public static class NumericShouldsWithTolerance
    {
        ...
        public static T ShouldEqualWithTolerance<T>(this T @this, double expectedValue, [Optional,DefaultParameterValue(1e-14d)] double tolerance, string message=null, params object[] args)
        {
            ...
            Expression<Func<IComparable<double>,bool>> inRange = Is.InRange(expectedValue -tolerance, expectedValue +tolerance);
        ...
        public static T ShouldNotEqualWithMargin<T>(this T @this, double expectedValue, double minimumDifference=1e-14d, string message=null, params object[] args)
        {
            Expression<Func<IComparable<double>,bool>> notInRange = Is.NotInRange(expectedValue -minimumDifference, expectedValue +minimumDifference);
