...
namespace TestBase
{
    public static class JQueryablePropertyValueShoulds
    {
        /// <summary>
        ///     <para>
        ///         Passes if <paramref name="actual" /> has a property named (where named can be a dotted path to a property
        ///         name) <paramref name="jsonexpression" /> with value <paramref name="expected" />
        ///     </para>
        ///     <para>
        ///         The property value is extracted using <see cref="JToken.SelectToken(string)" /> and
        ///         <see cref="JToken.ToObject" />
        ///     </para>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="actual">the value being tested</param>
        /// <param name="jsonexpression">
        ///     A Json syntax expression naming a property of <paramref name="actual" /> e.g. "length" or
        ///     "agents.rows[0].telephone"
        /// </param>
        /// <param name="expected">the expected value</param>
        /// <returns><paramref name="actual" /> if the assertion passes. Throws otherwise.</returns>
        public static T Property<T, TValue>(
            this T          actual,
        ...
        /// <summary>
        ///     <para>
        ///         Returns a property on <paramref name="actual" /> named --where named can also mean a dotted path to a property
        ///         name--
        ///         <paramref name="jsonexpression" />
        ///     </para>
        ///     <para>
        ///         The property value is extracted using <see cref="JToken.SelectToken(string)" /> and
        ///         <see cref="JToken.ToObject{T}()" />
        ///     </para>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="actual">the value being tested</param>
        ...
        /// </param>
        /// <param name="type">
        ///     type <see cref="System.Type" /> of the expected value. The found property is converted to this type
        ///     and then returned.
        /// </param>
        ...
        ///     <para>
        ///         Returns a property on <paramref name="actual" /> named �where named can also mean a dotted path to a property
        ///         name� <paramref name="jsonexpression" />
        ///     </para>
        ///     <para>
        ///         The property value is extracted using <see cref="JToken.SelectToken(string)" /> and
        ///         <see cref="JToken.ToObject" />
        ...
        /// </param>
        /// <returns>
        ///     The property of <paramref name="actual" /> named by <paramref name="jsonexpression" />, as a
