...
namespace TestBase.Tests.ShouldsCorrectnessTests
{
    ...
    public class ShouldEqualByValueExceptForValueTests
    {
        ...
        public void Given_lists_that_are_the_same_after_ordering_except_for_exceptions_should_pass(params object[] testcase)
        {
            ...
            actual.ShouldEqualByValueExpectForValuesIgnoringOrder(expected, exceptions);
