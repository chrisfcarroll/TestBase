...
namespace TestBase.Tests.ShouldsCorrectnessAndVerbosityTests
{
    ...
    class WhenComparingNumbersWithTolerance
    {
        ...
        public void ShouldNotEqualWithMargin__Should_fail_when_different_by_less_than_margin(double left, double tolerance)
        {
            var right1 = left + tolerance * 0.999999999999d;
            var right2 = left - tolerance * 0.999999999999d;
        ...
        [TestCase(1e308d, 1e294d)]
        [TestCase(5e-324d, 5e-324d)]
        public void ShouldBeGreaterThanOrEqualWithTolerance__Should_Pass_when_within_tolerance(double actual, double tolerance)
        {
        ...
        [TestCase(5e-318d, 5e-321d)]
        public void ShouldBeGreaterThanOrEqualWithTolerance__Should_Fail_when_outside_tolerance(double actual, double tolerance)
        {
        ...
        [TestCase(1e308d, 1e294d)]
        [TestCase(5e-324d, 5e-324d)]
        public void ShouldBeLessThanOrEqualWithTolerance__Should_Pass_when_within_tolerance(double actual, double tolerance)
        {
            var right = actual - tolerance * 0.99999999999d;
            var left = actual + tolerance * 0.999999999999d;
        ...
        [TestCase(1e304d, 1e294d)]
        [TestCase(5e-318d, 5e-321d)]
        public void ShouldBeLessThanOrEqualWithTolerance__Should_Fail_when_outside_tolerance(double actual, double tolerance)
        {
            var right = actual - tolerance * 1.001d;
            var left = actual + tolerance * 1.001d;
