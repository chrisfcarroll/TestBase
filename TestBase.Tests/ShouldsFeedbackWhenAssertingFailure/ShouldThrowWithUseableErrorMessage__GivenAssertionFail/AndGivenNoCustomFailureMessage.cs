...
namespace TestBase.Tests.ShouldsFeedbackWhenAsserting.ShouldThrowWithUseableErrorMessage__GivenAssertionFail
{
    ...
    public static class TestCasesForNoCustomFailureMessage
    {
            ...
            = new Dictionary<string,KeyValuePair<Action, string>>()
        {
            ...
            { "ShouldContainEachOf(string)", new KeyValuePair<Action,string>(() => "18".ShouldContainEachOf( new[]{"boo","booboo"}), null) } ,
            { "ShouldBeOneOf", new KeyValuePair<Action,string>(() => "18".ShouldBeOneOf( new[]{ "17", "19"}), null) } ,
            { "ShouldBeIn", new KeyValuePair<Action,string>(() => "18".ShouldBeIn( new[]{ "17", "19"}), null) } ,
            { "ShouldNotBeOneOf", new KeyValuePair<Action,string>(() => "18".ShouldNotBeOneOf( new[]{ "17", "18"}), null) } ,
            { "ShouldNotBeInList", new KeyValuePair<Action,string>(() => "18".ShouldNotBeInList( new[]{ "17", "18"}), null) } ,
