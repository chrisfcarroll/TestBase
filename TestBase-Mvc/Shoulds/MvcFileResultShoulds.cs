...
namespace TestBase.Shoulds
{
    ...
    {
        public static FileResult ShouldBeFileResult(
            ...
            params object[]   args)
        {
            return result
                  ...
                  .ShouldHave(
                              ...
                              message
                           ?? string.Format("Expected FileResult with FileDownloadName {0}", fileDownloadName),
                              args);
        }

        public static FileContentResult ShouldBeFileContentResult(
            this ActionResult result,
            string            fileDownloadName = null,
            string            message          = null,
            params object[]   args)
        ...
        public static FileStreamResult ShouldBeFileStreamResult(
            this ActionResult result,
            string            fileDownloadName = null,
            string            message          = null,
            params object[]   args)
