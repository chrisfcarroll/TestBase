...
namespace TestBase
{
    public static class HttpResponseMessageShoulds
    {
        ...
        public static HttpResponseMessage ShouldBe(this HttpResponseMessage response, int expectedHttpStatusCode) => ShouldBe(response, (HttpStatusCode) expectedHttpStatusCode);
